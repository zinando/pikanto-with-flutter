...
class _SearchViewState extends State<SearchView> {
        ...
        builder: (BuildContext context) {
          return ApprovalRequestDialog(
            ...
            onSubmit: (List<Map<String, dynamic>> weightList, String message) {
              _weightList = List.filled(10, weightList)
  ...
  Widget build(BuildContext context) {
    ...
    List<Map<String, dynamic>> _weightRecords = _weightList.sublist(startIndex,
        endIndex > _weightList.length ? _weightList.length : endIndex);
    int totalPages = _calculateTotalPages(_weightList.length, _recordsPerPage);
    return Padding(
      padding: const EdgeInsets.all(8.0),
      child: Column(
        children: [
          // create a search input field half the width of the screen
          Container(
